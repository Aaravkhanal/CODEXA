...
export const codexaLensFileStatusSchema = z.enum([
  "inspected",
  "modified",
  "failed",
  "verified",
...
export const codexaLensActivityEventSchema = z.object({
  id: z.string(),
  toolCallId: z.string(),
  toolName: z.string(),
  phase: z.enum(["started", "completed"]),
  status: codexaLensFileStatusSchema,
...
export type CodexaLensFileStatus = z.infer<typeof codexaLensFileStatusSchema>;
export type CodexaLensActivityEvent = z.infer<typeof codexaLensActivityEventSchema>;
...
export const messagePartSchema = z.discriminatedUnion("type", [
  ...
  z.object({
    ...
    activity: z
      .object({
        started: codexaLensActivityEventSchema,
        completed: codexaLensActivityEventSchema.optional(),
      })
      .optional(),
  }),
  z.object({
...
export const chatStreamEventSchema = z.discriminatedUnion("type", [
  ...
  z.object({
    type: z.literal("codexalens-activity"),
    event: codexaLensActivityEventSchema,
  }),
  z.object({
    type: z.literal("done"),
    messageId: z.string(),
