...
import type { Prisma } from "@codexa/database";
import { getToolContracts } from "@codexa/shared";
...
const app = new Hono<AuthenticatedEnv>()
  .post(
    ...
    async (c) => {
      ...
      const nextMessages = await validateUIMessages<CodexaUIMessage>({
    ...
    return result.toUIMessageStreamResponse<CodexaUIMessage>({
