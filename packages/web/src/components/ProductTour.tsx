...
function CODEXACommandPalette() {
  ...
  return (
    <MacFrame scene="monolith" title="codexa — commands" variant="scene-commands">
      <div ref={containerRef} className="terminal-canvas command-mockup palette-mockup" role="img" aria-label="CODEXA slash-command palette">
...
function ActivityMockup() {
  ...
  return (
    <MacFrame scene="alpine" title="codexa — session" variant="scene-activity">
      <div ref={canvasRef} className="terminal-canvas activity-mockup" role="img" aria-label="CODEXA tool activity interface">
...
function AnalysisMockup() {
  ...
  return (
    <MacFrame scene="monolith" title="codexa — analysis" variant="scene-analysis">
      <section ref={canvasRef} className="terminal-canvas analysis-mockup" aria-label="CODEXA repository analysis response">
...
function ThemeMockup() {
  ...
  return (
    <MacFrame scene="alpine" title="codexa — theme" variant="scene-theme">
      <section ref={canvasRef} className="terminal-canvas theme-mockup" style={style} aria-label="Animated CODEXA theme selector">
...
function PlanBuildMockup() {
  ...
  return (
    <MacFrame scene="monolith" title="codexa — plan & build" variant="scene-plan-build">
      <section ref={canvasRef} className="terminal-canvas plan-build-mockup-inner" aria-label="CODEXA plan and build modes">
  ...
  return (
    <div className="product-tour section-shell" id="product">
      <div className="tour-intro">
        <AnimatedSectionHeading>See CODEXA at work.</AnimatedSectionHeading>
      ...
      <TourSection
        ...
        copy="Type / in the prompt to open CODEXA commands without leaving the active terminal. Start or resume persistent workspaces, switch backend models and agents, and customize your theme settings instantly."
        mockup={<CODEXACommandPalette />}
      />
      <TourSection
        number="02 / ACTIVITY"
