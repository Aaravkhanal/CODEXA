...
export function CodexaLensWorkspacePanel({
  activityPaths,
  initialPath,
}: {
  ...
  const [index, setIndex] = useState<CodexaLensWorkspaceIndex | null>(null);
  const [preview, setPreview] = useState<CodexaLensFilePreview | null>(null);
  ...
  const [searchMatches, setSearchMatches] = useState<CodexaLensSearchMatch[]>([]);
